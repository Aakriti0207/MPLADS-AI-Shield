...
def test_upload_endpoint_exposes_phase12_analysis(client, admin_auth_headers):
    # Phase 7: /upload-analyze now requires the Administrator role
    # (require_role(ADMIN_ROLE) -- see app/routes/upload.py), so this
    # uses the admin_auth_headers fixture rather than the plain
    # (District Authority) auth_headers fixture.
